...
metric = metrics.Accuracy()  # Initialize the metric outside the loop

for window_data in rolling_window:
    prev_X, prev_y = zip(*window_data)
    
    if window_counter == 0:
        # Train the model with the first set of data
